...
namespace ZombieChezLeComte
{
    ...
    public class ScreenNuit6 : GameScreen
    {
        ...
        public override void Initialize()
        {
            ...
            huntGhost.Initialize(new Vector2(0, 0), Constantes.NIGHT6_HUNT_GHOST_SPEED);
            doorGhost.Initialize(new Vector2(0, 0), 0);
            runGhost.Initialize(new Vector2(10, 10), Constantes.NIGHT6_RUN_GHOST_SPEED);
            zombie.Initialiaze(new Vector2(40, -210), Constantes.NIGHT6_ZOMBIE_SPEED);
