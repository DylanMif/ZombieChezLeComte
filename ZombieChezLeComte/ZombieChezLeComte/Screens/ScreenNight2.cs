...
namespace ZombieChezLeComte
{
    ...
    public class ScreenNight2 : GameScreen
    {
        ...
        public override void Initialize()
        {
            ...
            armures[0].Initialize(new Vector2(4788, 6370), 122, 28, "armure1", "J'ai jamais vu autant de poussiere");
            armures[1].Initialize(new Vector2(4215, 6530), 70, 28, "armure2", "Elles doivent valoir une fortune");
            feu.Initialize(new Vector2(4990, 6372), 40, 30, "feu", "Ca fait du bien de se rechauffer !");
